    ...
    <div v-for="info in infos ">
      ...
      <div> 
        ...
        <span class="d-flex "><svg xmlns="http://www.w3.org/2000/svg" height="24px"
          ...
          <a v-else :href="'/formations/'+info.id "  class="d-flex " >
